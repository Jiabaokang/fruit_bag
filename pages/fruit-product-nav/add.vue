<template>
	<view class="uni-container">
		<uni-forms ref="form" :model="formData" validate-trigger="submit" err-show-type="toast">
			...
			<uni-forms-item name="icon" label="图标" required>
				<!-- <uni-file-picker v-model="formData.icon" title="封面" limit="1" file-mediatype="*/image"></uni-file-picker> -->
				<uni-file-picker return-type="object" v-model="formData.icon" :imageStyles="imageStyle"></uni-file-picker>
			</uni-forms-item>
