				...
				<view class="top">
					...
					<view class="right">
						<view class="row">
							...
							<view class="remove">
								<uni-icons type="minus-filled" size="30" color="#ee4626" @click="removeAward(item)" v-if="true"></uni-icons>
							</view>
						</view>
		...
		<view class="more">
			...
			<view class="content">
				...
				<view class="row">
					...
					<view class="control">
						<switch :checked="isRepeat" @change="changeRepeat" color="#ee4626" style="transform: scale(0.8); transform-origin: right;" />
					</view>
				</view>
			</view>
...
import { getFileExtension, uuid } from '../../utils/tools';
